...
var modal_tem = '<div class="modal fade" role="dialog">' +
        ...
        '<b><h4 style="margin-top: 5px;margin-bottom: 5px"></h4></b>' +
        '<h5 style="margin-top: 5px;margin-bottom: 5px"></h5>' +
        '</div>' +
        '</div>' +
        '<div class="container-fluid"><div class="row" style="margin-top:10px;margin-bottom:5px"><div class="col-xl-6 text-left"><h5 id="dateasat">As at </h5></div><div class="col-xl-6 text-right"><h5 id="genby"> </h5></div></div></div>' +
        '<div class="container-fluid">' +
        '<div class="tbll row" style="font-size: smaller">' +
        '</div>' +
        '<br>' +
