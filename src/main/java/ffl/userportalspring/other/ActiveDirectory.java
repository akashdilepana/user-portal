...
public class ActiveDirectory {
    ...
    public static LdapContext getConnection(String username, String password, String domainName, String serverName) throws NamingException {
        ...
        //System.out.println(domainName.replace("regalfs.", ""));
        String principalName = username + "@" + domainName.replace("regalfs.", "");
        ...
        String ldapURL = "ldap://ad1.fintrex.lk:389";
    ...
    public static void main(String[] args) {
        try {
            ...
            LdapContext ctx = ActiveDirectory.getConnection("thisara", "thiz@234", "regalfs.regalfinance.com");
            ActiveDirectory.User Ad_user = ActiveDirectory.getUser("thisara", ctx);
//            System.out.println(Ad_user.getCommonName());
//            System.out.println(Ad_user.getDistinguishedName());
//            System.out.println(Ad_user.getUserPrincipal());
//            System.out.println(Ad_user.toString());
//            
            User[] users = ActiveDirectory.getUsers(ctx);
            for (User user : users) {
                String[] ou = user.getDistinguishedName().split("OU=");
                //  System.out.println(user.getDistinguishedName().split("OU="));
                // System.out.println(ou.length);
                if (ou.length > 1) {
                    System.out.println(user.getCommonName() + " - " + ou[1]);
                }
